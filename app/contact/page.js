    ...
    <>
          ...
          <div className="flex flex-col lg:w-1/3">
            ...
            <div className='flex flex-col text-left mt-6'>
              <div className="font-['Quicksand'] text-lg md:text-2xl font-medium text-[rgb(129,129,129)] leading-relaxed">
                <p>Birla Institute of Technology and Science, Pilani, K K Birla Goa Campus, Zuarinagar, Sancoale, Goa - 403726, India.</p>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-[rgb(241,116,0)] py-16 md:py-20">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row justify-center items-stretch gap-8 lg:gap-12">
          ...
          {/* Card 1: Email */}
          <div className="bg-white rounded-2xl p-8 shadow-xl flex flex-col items-center justify-center w-full lg:w-90 transition-transform hover:-translate-y-1">
            ...
            <p className="font-['Quicksand'] text-lg text-gray-600 break-all">bgiies.office@goa.bits-pilani.ac.in</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl flex flex-col items-center justify-center w-full lg:w-90 transition-transform hover:-translate-y-1">
            ...
            <p className="font-['Quicksand'] text-lg text-gray-600">0832-258-0254</p>
          </div>

          {/* Card 3: Follow Us */}
          <div className="bg-white rounded-2xl p-8 shadow-xl w-full lg:w-90 flex flex-col items-center justify-center transition-transform hover:-translate-y-1">
            ...
            <div className="flex flex-row flex-wrap justify-center gap-4">
              ...
              <a href="https://www.linkedin.com/company/bgiies/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[rgb(241,116,0)] rounded-full hover:scale-110 transition-transform duration-200">
                <img src="/contact-ld.svg" alt="LinkedIn" className="w-6 h-6" />
              </a>

              {/* Instagram */}
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[rgb(241,116,0)] rounded-full hover:scale-110 transition-transform duration-200">

    ...
    <>
      <div className="relative w-full h-screen overflow-x-hidden">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-4 sm:gap-6 px-4 sm:px-8">
          {/* Logo */}
          <img src="/bgiies_logo.png" alt="BGIIES Logo" className="w-56" />
          ...
          <div className="items-center justify-center flex flex-col">
            ...
            <p className="">
              innovation and entrepreneurship by providing mentorship, funding,
              and resources
            </p>
            <p className="">to help turn ideas into successful ventures.</p>
          </div>
        </div>
      </div>
      ...
      <section className="w-full px-6 sm:px-10 lg:px-16 py-12 bg-transparent">
        <div className="max-w-[1400px] mx-auto">
          ...
          <article className="relative bg-white/90 rounded-lg shadow-md overflow-hidden border border-gray-200 mt-8">
              ...
              <div className="md:w-1/2 p-6 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-600">
                    Modern conference room with a smart board, offering seamless
                    presentations and interactive collaboration for effective
                    meetings.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-6 justify-center flex hover:scale-110 transition-transform duration-200">
                  <a
                    className="px-4 py-2 bg-indigo-700 text-white rounded-full hover:bg-indigo-800"
                    href="https://forms.gle/qLofbVcx8Ju5ebRY8"
                    target="_blank" rel="noopener noreferrer"
                  >
                    I want to Book an Equipment/Space
                  </a>
                </div>
        </div>
      </section>
